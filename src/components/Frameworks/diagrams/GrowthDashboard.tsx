...
export default function GrowthDashboard({ content, interactive, showDescriptions = true, onContentChange }: Props) {
    ...
    const Node = ({ title, id, children, type = 'leaf', note }: { title: string, id?: string, children?: React.ReactNode, type?: 'root' | 'category' | 'leaf', note?: string }) => {
        const bgClass = type === 'root' || type === 'category'
            ? 'bg-zinc-800 text-white border-2 border-emerald-900'
            : 'bg-zinc-900 text-zinc-200 border border-zinc-900';
            ...
            <div className="flex flex-col items-center relative group">
                ...
                {children && (
                    <div className="flex flex-col items-center w-full">
                        <div className="h-6 w-px bg-zinc-900 group-hover:bg-emerald-500/50 transition-colors"></div>
    ...
    const VLine = () => <div className="h-6 w-px bg-zinc-900 mx-auto"></div>;
        ...
        <div className="w-full min-w-[2000px] p-8 font-sans text-zinc-200 bg-zinc-950 overflow-x-auto">
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="flex gap-32 relative pt-4 w-full justify-center">
                    <div className="absolute top-0 left-[35%] right-[35%] h-px bg-zinc-900"></div>
                    ...
                    <div className="flex flex-col items-center flex-1">
                        ...
                        <div className="flex gap-24 relative pt-4 w-full justify-center items-start">
                            <div className="absolute top-0 left-[25%] right-[25%] h-px bg-zinc-900"></div>

                            <div className="flex flex-col items-center">
                                <Node title="Inorganic" type="category" />
                                <div className="mt-4 flex gap-4 items-start pt-4 border-t border-zinc-900">
                            ...
                            <div className="flex flex-col items-center flex-grow">
                                ...
                                <div className="mt-4 flex justify-center gap-12 pt-4 border-t border-zinc-900">
                                    ...
                                    <div className="mt-4 pt-4 border-t border-zinc-900 relative w-full flex justify-center gap-8">
                                        ...
                                        <div className="flex flex-col items-center">
                                            ...
                                            <div className="pt-4 flex flex-col gap-2 pl-4 border-l border-zinc-900 mt-4">
                                ...
                                <div className="flex flex-col items-center min-w-[320px]">
                                    ...
                                    <div className="flex gap-8 mt-4 pt-4 border-t border-zinc-900 w-full justify-center relative">
                                        <div className="absolute top-0 left-[25%] right-[25%] h-px bg-zinc-900"></div>
                                        ...
                                        <div className="flex flex-col items-center">
                                            <VLine />
                                            <VLine />
                                            <div className="p-2 border border-zinc-900 rounded bg-zinc-800 text-white font-bold text-xs mb-2">Revenue/User</div>
                                        ...
                                        <div className="flex flex-col items-center">
                                            <VLine />
                                            <div className="p-2 border border-zinc-900 rounded bg-zinc-800 text-white font-bold text-xs mb-2">Cost/User</div>
                                            ...
                                            <div className="flex gap-4 pt-2 relative">
                                                ...
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <div className="mt-2 text-[10px] text-zinc-400 border border-dashed border-zinc-900 p-1 rounded max-w-[100px] text-center bg-zinc-900">
