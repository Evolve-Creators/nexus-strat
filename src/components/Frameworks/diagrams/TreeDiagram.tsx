    ...
    return (
        <div className="flex flex-col items-center mx-2 relative">
            ...
            <div className={`
                ...
                ${isRoot
                    ? 'bg-zinc-900 border-emerald-500/50 shadow-[0_0_15px_rgba(16,185,129,0.2)]'
                    : 'bg-zinc-900/60 border-zinc-700 hover:border-zinc-500'}
            `}>
                <div className={`
                    text-center font-bold text-sm border-b pb-1 mb-1
                    ${isRoot ? 'text-white border-emerald-500/30' : 'text-zinc-300 border-zinc-700'}
                `}>
                    {section.name}
                </div>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="relative flex justify-center pt-0">
                        ...
                        {section.children.length > 1 && (
                            <div className="absolute top-0 left-0 right-0 h-px bg-zinc-700 marker-line">
                                    ...
                                    <div key={child.id} className="flex flex-col items-center relative">
                                        ...
                                        {!isOnly && (
                                            <div className="absolute top-0 w-full h-px">
                                                {/* Left segment */}
                                                <div className={`absolute top-0 left-0 w-1/2 h-full ${isFirst ? 'bg-transparent' : 'bg-zinc-700'}`}></div>
                                                {/* Right segment */}
                                                <div className={`absolute top-0 right-0 w-1/2 h-full ${isLast ? 'bg-transparent' : 'bg-zinc-700'}`}></div>
                                            </div>
                                        )}
